...
//==> Maella [FAF] -Allow Bandwidth Settings in <1KB Incremements-
#ifdef FAF
	SetDlgItemInt(IDC_WIZ_TRUEDOWNLOAD_BOX, 0.0f, FALSE);
	SetDlgItemInt(IDC_WIZ_TRUEUPLOAD_BOX, 0.0f, FALSE);
#else
	SetDlgItemInt(IDC_WIZ_TRUEDOWNLOAD_BOX, 0, FALSE);
	SetDlgItemInt(IDC_WIZ_TRUEUPLOAD_BOX, 0, FALSE);
#endif
...
//==> Maella [FAF] -Allow Bandwidth Settings in <1KB Incremements-
#ifdef FAF
		case  1: down= thePrefs.maxGraphDownloadRate * 8; up= thePrefs.GetMaxGraphUploadRate(true) * 8; break;
#else
