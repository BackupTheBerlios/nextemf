...
#ifdef LINPRIO
#define MP_CAT_SHOWHIDEPAUSED	10352
#define MP_CAT_SETRESUMEORDER	10353
#define	MP_CAT_ORDERAUTOINC		10354
#define MP_CAT_ORDERSTEPTHRU	10355
#define MP_CAT_ORDERALLSAME		10356
#endif
//<== Linear Prio [shadow2004]
